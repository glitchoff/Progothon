            ...
            <section id="how-it-works" className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="flex flex-col items-center text-center">
                            <img
                                src="https://images.pexels.com/photos/5699431/pexels-photo-5699431.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="relative">
                            <img
                                src="https://images.pexels.com/photos/8942528/pexels-photo-8942528.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
